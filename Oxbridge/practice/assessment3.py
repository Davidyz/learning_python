...
############################# Q4 ############################
plt.scatter(table_galaxy["ra"], table_galaxy["dec"], c=table_galaxy["redshift"], s=1)
...
plt.hist(table_galaxy["color"], bins=1000)
plt.xlim(0, 4)
...
############################# Q6 ###############################
y, x, _ = plt.hist(
    table_galaxy["u"] - table_galaxy["r"], bins=1000, alpha=1, label="counts"
)
x = (x[1:] + x[:-1]) / 2
mean1, mean2 = 0, 0
